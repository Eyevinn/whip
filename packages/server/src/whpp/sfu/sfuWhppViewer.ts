...
import { WhppAnswerRequest, WhppCandidateRequest, WhppOfferResponse } from '../whppRequests'
...
export class SfuWhppViewer extends EventEmitter implements WhppViewer {
  ...
  private sfuProtocol: SmbProtocol = new SmbProtocol();

  constructor(channelId: string, sfuResourceId: string, mediaStreams?: MediaStreamsInfo) {
    super();
